Feature: presence-api
  ...
  Background:
    ...
    * def MQTTConnector = Java.type('com.project.common.MQTTConnector')
...
# Getting credentials for MQTT with error message

* path 'users/'+ devices_agent_id +'/session'
...
* match response.message == "There is already."
